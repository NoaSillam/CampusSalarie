...
<div class="row justify-content-center align-items-center">
  <div class="col-md-3 form-group d-flex align-items-center">
  <label for="mail" class="col-form-label label" style="width: 45%;">Mail : <sup class="required">*</sup></label>
...
<div class="row justify-content-center align-items-center">
  <div class="col-md-3 form-group d-flex align-items-center">
  <label for="montant" class="col-form-label label" style="width: 50%;">Montant : <sup class="required">*</sup></label>
