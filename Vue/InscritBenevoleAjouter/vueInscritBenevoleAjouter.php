...
<h2 style="text-align: center;">S'inscrire pour être bénévole</h2>
<br>
<div style="display: flex; align-items: center; justify-content: center;">
<form action="index.php?action=ajoutBenevole" method="post">
...
<label class="form-check-label" for="inlineRadio2">Monsieur</label>
  ...
  <label for="prenom" class="col-form-label label" style="width: 75%;">Prénom : <sup class="required">*</sup></label>
...
<div class="row justify-content-center align-items-center">
  ...
  <label for="numTelephone" class="col-form-label label" style="width: 45%;">Téléphone : </label>
    <input type="text"  style="text-align: center; width: 60%" class="form-control" name="numTelephone" required>
  </div>
  <div class="col-md-5 form-group d-flex align-items-center">
