...
<form action="index.php?action=modifPrestataire" method="post" enctype="multipart/form-data">
...
<div class="row justify-content-center align-items-center">
  ...
  <label for="nomPrestataire" class="col-form-label " style="width: 100%;">Nom du Prestataire : <sup class="required">*</sup></label>
    <input type="text"  style="text-align: center;" class="form-control" name="nomPrestataire" value="<?= $presta['nomPrestataire'] ?>" required>
  </div>
  ...
  <input type="file"  style="text-align: center; width: 210%;" class="form-control" name="logo" value="<?= $presta['logo']?>" required>
  </div>
  ...
  <input type="text"  style="text-align: center; width: 50%;" class="form-control" name="codePostal" value="<?= $presta['codePostal'] ?>" required>
  </div>
</div>
<br>
<div class="col-md-10 form-group d-flex align-items-center">
    <label for="description" class="col-form-label ">Description : <sup class="required">*</sup></label>
    <textarea name="description" rows="10" cols="50" required><?= $presta['Description']?></textarea>
    </div>
<br>
    <input type="hidden"  style="text-align: center;"  class="form-control"  name="id" value="<?= $presta['id']?>" readonly="readonly">
